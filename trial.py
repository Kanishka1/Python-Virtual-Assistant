...
def index():
    ...
    class MyFrame(wx.Frame):
        def __init__(self):
            wx.Frame.__init__(self, None,pos=wx.DefaultPosition, size=wx.Size(1250,950),style=wx.MAXIMIZE_BOX | wx.SYSTEM_MENU | wx.CAPTION |wx.CLOSE_BOX | wx.CLIP_CHILDREN,
            ...
            speak.Speak("To begin with your queries either type or press the ENTER KEY so that I can recognize your voice")
